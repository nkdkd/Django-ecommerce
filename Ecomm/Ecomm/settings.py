...
ALLOWED_HOSTS = ['127.0.0.1','16.171.199.1' 'djangotest.com', 'django-ecommerce-production-81b6.up.railway.app']
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD_YO'),  # Replace with your database password
